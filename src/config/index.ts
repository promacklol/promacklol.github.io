...
export const SITE_CONTENT: SiteContent = {
  ...
  projects: [
    ...
    },
    {
      ...
      summary: "Utilitaire de sécurité automatisant la création et la rotation des points de restauration Windows via une interface C# (.NET 9) pilotant PowerShell.",
      linkPreview: "/",
